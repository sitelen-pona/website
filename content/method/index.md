...
{% split %}
{% en %}
The methodology used to define [Common Sitelen Pona](/common.html) was primarily developed by [Mrs. Lang](/members.html#mrs-lang), the language's founder, with some contributions and changes collaboratively made by various members of the working group. This methodology, described below, was subsequently approved for use by a majority of the working group.

The development of Common Sitelen Pona required us to answer several questions. The majority of this work was involved in determining what ["tier of teachability"](/method/tiers.html) each [word character](/method/words.html) would belong to, based on the word's reported and observable usage, as well as its utilization by publishers. Further, each received [a singular determined representative glyph](/method/glyphs.html) based on similar criteria, with different members of the working group assigned to that effort.

Some matters were resolved by alternative processes. One complexity that arose was the issue of whether certain alternate glyphs [were semantically distinct enough](/method/semantic-alts.html) from the primary glyph for the same word. The words with glyphs that met this criteria would require separate codepoints in Unicode, and similarly would need to be recognized and adopted into Common Sitelen Pona as separate characters. The association studied this issue by community-wide survey, asking members of the community to report whether and how they distinguish the glyphs in question. The association then utilized that data to determine via vote, which such alternative glyphs should be included. 
...
{% sp %}
kepeken nasin seme la kulupu pali li kama sona e [sitelen+pona kulupu](/common.html) li lipu e ona  
...
mi pali e lipu pi(sitelen+pona kulupu) la mi kulupu li wile e sona ante mute  
alasa suli nanpa wan li ni  
zz nimi ale pi(toki+pona)  la [sitelen nimi seme](/method/words.html) li [suli tawa kepeken kulupu](/method/tiers.html) zz  
zz mi alasa zz jan li toki seme e nasin kepeken pi(nimi ni<)    
zz zz zz  zz mi ken lukin e kepeken seme pi(nimi ni<) lon toki kulupu  
zz zz zz zz lipu mama li kepeken ala kepeken nimi ni<   
alasa suli nanpa tu li alasa e sona pi(ijo ante) kepeken nasin pi(sama mute)   
zz lipu pi(sitelen+pona kulupu) la sitelen nimi ale o seme lukin o kepeken [selo seme](/method/glyphs.html)   
zz tan selo ken ale pi(sitelen nimi wan) la  
zz zz lipu pi(sitelen+pona kulupu) li pana e selo wan tawa sitelen nimi wan    
zz ni^ la kulupu li alasa e selo pi(kepeken kulupu)    
 alasa suli tu ni^ li tawa jan ante pi(kulupu pali)
...
zz kama la jan sona mute pi(kulupu pali) li lukin e pilin pi(kulupu suli)   
zz zz li toki e wile ona ni> zz [selo seme pi(sitelen sama) o lon lipu](/method/semantic-alts.html)  
...
{% endsp %}
{% sl %}
kepeken nasin seme la kulupu pali li kama sona e [sitelen pona kulupu](/common.html) li lipu e ona? suli la [anpa sewi](/members.html#mrs-lang) li pali e nasin. jan ante pi kulupu pali li pali poka li pana e pali lili e ante lili. pini la jan mute pi kulupu pali li wile e ni: kulupu li kepeken nasin. lipu ni li toki suli e nasin.

pali ni la mi kulupu li wile e sona ante mute. pali pi mute nanpa wan li tawa alasa ni: [sitelen nimi seme](/method/words.html) li suli tawa kepeken kulupu? nimi ale pi toki pona la mi lukin e ni: jan li toki seme e kepeken pi nimi ni; mi ken lukin e kepeken seme pi nimi ni lon toki kulupu; lipu mama li kepeken ala kepeken nimi ni.  alasa nanpa wan li pini la alasa nanpa tu li kepeken nasin pi sama mute li alasa e sona pi ijo ante: lipu pi sitelen pona kulupu la sitelen nimi ale o seme lukin o [selo seme](/method/glyphs.html). tan selo ken ale pi sitelen nimi la lipu pi sitelen pona kulupu li pana e ona wan taso tawa sitelen nimi wan. ni la kulupu li alasa e selo pi kepeken kulupu. alasa suli tu ni li tawa jan ante pi kulupu pali.
